...
export function createTimingStore(options) {
	...
	return { begin, noteFetch, noteSent, claimsRequest, notePhase, noteResponseBytes, noteResponseEncoding, notePrewarm, notePrewarmMiss, observeChunk, finish, summarize, snapshot };
}
