...
export function createTimingStore(options) {
	...
	return { begin, seed, has, clear, stats, noteFetch, noteSent, claimsRequest, notePhase, noteResponseBytes, noteResponseEncoding, notePrewarm, notePrewarmMiss, observeChunk, finish, summarize, snapshot };
}
