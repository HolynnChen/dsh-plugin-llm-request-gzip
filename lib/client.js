...
window.__ModuleLoader__.load({
	...
	factory: (require) => {
		...
		const TS = {
			...
			head: { display: "flex", alignItems: "baseline", gap: "10px", flexWrap: "wrap", flex: "none" },
			title: { margin: 0, fontSize: "15px", fontWeight: 600, lineHeight: 1.4 },
			intro: { margin: 0, fontSize: "12.5px", lineHeight: "19px", color: "var(--dsw-alias-label-tertiary)", flex: "none" },
		...
		function TimingView(props) {
			...
			return h("div", { style: TS.root }, children);
		}
