...
import { headersMatch, isShapeRejection, messagesPrefixEnd, moveMessagesLast, predictAssistantCommonIncrement, prewarmPrefix } from "./prewarm.js";
...
/**
 * Endpoints that rejected a body with `messages` moved to the end. JSON objects
 * are unordered, so this should not happen — but a hand-rolled relay may match on
 * the body's shape, and one wasted request is a cheaper way to find that out than
