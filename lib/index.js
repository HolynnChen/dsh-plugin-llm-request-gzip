...
export const Config = z.object({
	...
	http2: z.boolean().default(true).description("Offer HTTP/2 to every provider that has it enabled. `false` is the plugin-wide kill switch."),
	allowInsecureH2c: z.boolean().default(false).description("Also use HTTP/2 for `http://` endpoints, over a cleartext connection with no certificate. Only for a link you trust."),
