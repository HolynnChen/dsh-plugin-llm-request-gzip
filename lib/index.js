...
import { headersMatch, isShapeRejection, messagesPrefixEnd, predictAssistantCommonIncrement, prewarmPrefix } from "./prewarm.js";
	...
	ctx.inject(["connection"], (connectionCtx) => {
		connectionCtx.connection.fetch.register({
			...
			fetch: async (request) => {
				...
				if (ledger !== undefined && !timing.has(sessionId)) {
					try {
